...
public class LocationActivity extends AppCompatActivity {
            ...
            public void onResponse(Call<User> call, Response<User> response) {
                if (response.isSuccessful()) {
                    ...
                    if (user != null) {
                        ...
                        String userName = user.getLocation();
                    ...
                    progressBar8.setVisibility(View.GONE);
                    Toast.makeText(LocationActivity.this, "Failed to fetch user: " + response.message(), Toast.LENGTH_SHORT).show();
                }
            }
    ...
    private void addUsername(String name) {
        User userUpdateRequest = new User(Integer.parseInt(userId), null, null,null,null,name,null,null,null,null,null,true,null,null);
        ...
        call1.enqueue(new Callback<Void>() {
            ...
            public void onResponse(Call<Void> call, Response<Void> response) {
                if (response.isSuccessful()) {
                    ...
                    Toast.makeText(LocationActivity.this, "Failed to update Link.", Toast.LENGTH_SHORT).show();
                }
            }
            ...
            public void onFailure(Call<Void> call, Throwable t) {
                ...
                Toast.makeText(LocationActivity.this, "Failed to Update Link."+t.getMessage(), Toast.LENGTH_SHORT).show();
            }
        });
